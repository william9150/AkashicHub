      ...
      <el-col :span="12">
        <el-card>
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item label="系統名稱">
              AkashicHub (阿卡西)
            </el-descriptions-item>
            <el-descriptions-item label="版本">
              v1.0.0
            </el-descriptions-item>
            <el-descriptions-item label="建置時間">
              2024-01-15
            </el-descriptions-item>
            <el-descriptions-item label="後端版本">
              Node.js v22 + Express
            </el-descriptions-item>
            ...
            <el-descriptions-item label="開發團隊">
              IT部門
            </el-descriptions-item>
          </el-descriptions>
        </el-card>
          ...
          <div class="system-status">
            <div class="status-item">
              ...
              <div class="status-value">
                <el-tag type="success">正常運行</el-tag>
              </div>
            </div>
